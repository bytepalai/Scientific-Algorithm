...
class Imagecaption(Resource):
    def get(self):
        return {"message": "Hello, World Image Captioning!"}
    ...
    def post(self): # Post route, will need better names
        ...
        # Save image
        cv2.imwrite('./image2.jpg', img) # Do i need to always save and read, maybe that might waste some time, also that might be customer data so maybe i shouldn't save or maybe i should
        ...
        output = caption('./image2.jpg')
        print("it took", time.time() - start, "seconds.")
        # It takes about 10 seconds on my old mac - should way faster on a compute shape on digital Ocean
